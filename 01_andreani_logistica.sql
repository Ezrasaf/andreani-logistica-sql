...
CREATE TABLE TipoEmpresa (
    ...
    Descripcion NVARCHAR(50) -- 'Laboratorio', 'Droguería', 'Distribuidor'
);
...
VALUES 
(1, 2, 'Demora', 'Entrega retrasada por tráfico en la zona norte.', '2025-06-11 10:30:00'),
(2, 4, 'Producto Dañado', 'Caja entregada con envase roto.', '2025-06-13 14:15:00'),
(3, 5, 'Error de dirección', 'Dirección del cliente mal ingresada.', '2025-06-14 09:45:00'),
(4, 7, 'Falta de producto', 'Se entregó sin una unidad solicitada.', '2025-06-16 16:00:00'),
(5, 9, 'Rechazo del cliente', 'Cliente no recibió la entrega por vencimiento cercano.', '2025-06-18 11:20:00');
...
-- 7. Carga de datos (mínimo 10 registros por tabla)
...
INSERT INTO Incidencia (ID_Incidencia, ID_Entrega, Tipo, Descripcion, FechaRegistro)
VALUES 
(1, 2, 'Demora', 'Entrega retrasada por tráfico en la zona norte.', '2025-06-11T10:30:00'),
(2, 4, 'Producto Dañado', 'Caja entregada con envase roto.', '2025-06-13T14:15:00'),
(3, 5, 'Error de dirección', 'Dirección del cliente mal ingresada.', '2025-06-14T09:45:00'),
(4, 7, 'Falta de producto', 'Se entregó sin una unidad solicitada.', '2025-06-16T16:00:00'),
(5, 9, 'Rechazo del cliente', 'Cliente no recibió la entrega por vencimiento cercano.', '2025-06-18T11:20:00');
